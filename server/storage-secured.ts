  ...
  static async getTripRequestsForApprovalSecured(req: Request): Promise<any[]> {
    ...
    const results = await db
      .select({
        ...
        homeDeductionKm: tripRequests.homeDeductionKm,
        urgencyType: tripRequests.urgencyType,
        tripType: tripRequests.tripType,
        createdAt: tripRequests.createdAt,
        tripDate: tripRequests.tripDate,
  ...
  static async getDepartmentsSecured(req: Request): Promise<any[]> {
    ...
    let query = db
      .select({
        ...
        secondManagerId: departments.secondManagerId,
        thirdManagerId: departments.thirdManagerId,
        parentDepartmentId: departments.parentDepartmentId,
        monthlyBudgetBonus: departments.monthlyBudgetBonus,
        monthlyBudgetBonusResetDate: departments.monthlyBudgetBonusResetDate,
  ...
  static async getProjectsSecured(req: Request): Promise<any[]> {
    ...
    let query = db
      .select({
        ...
        originalBudget: projects.originalBudget,
        budgetAdjustments: projects.budgetAdjustments,
        expiryDate: projects.expiryDate,
